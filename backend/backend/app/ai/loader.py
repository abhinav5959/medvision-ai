...
def load_binary_model():
    ...
    binary_model.load_state_dict(torch.load(settings.BINARY_WEIGHTS, map_location=inference.DEVICE))
...
def load_type_model():
    ...
    type_model.load_state_dict(torch.load(settings.TYPE_WEIGHTS, map_location=inference.DEVICE))
